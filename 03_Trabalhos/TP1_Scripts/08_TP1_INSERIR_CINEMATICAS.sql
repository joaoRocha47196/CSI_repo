...
VALUES
    (1, 'Carro', 0.0, ROW( ROW( 1, 1 ), 1.3 ), ROW( ROW( 0.5, 3 ), 1.0 ), ST_GeomFromText( 'POINT( 5 6 )', 3763 )),
    (2, 'Mota', 0.0, ROW( ROW( 1, 1 ), 0.3 ), ROW( ROW( 2, 0.5 ), 1.0 ), ST_GeomFromText( 'POINT( 2 3 )', 3763 )),
    (3, 'Camiao', 0.0, ROW( ROW( 1, 1 ), 1.3 ), ROW( ROW( 0.5, 3 ), 1.0 ), ST_GeomFromText( 'POINT( 5 6 )', 3763 ));

INSERT INTO objeto_movel( id, id_cinematica, nome, geo )
VALUES
    (1, 1, 'Carro', ST_GeomFromText( 'POLYGON( ( 0 0, 2 0, 2 1, 0 1, 0 0 ) )', 3763 )),
    (2, 2, 'Mota', ST_GeomFromText( 'POLYGON( ( 0 0, 2 0, 2 1, 0 1, 0 0 ) )', 3763 )),
    (3, 3, 'Camiao', ST_GeomFromText( 'POLYGON( ( 0 0, 2 0, 2 1, 0 1, 0 0 ) )', 3763 ));
